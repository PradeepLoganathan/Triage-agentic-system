...
class AgentUtilsTest {
    ...
    // ==================== extractServiceFromClassification ====================
    ...
    class IsValidJson {
        ...
        void invalidJsonReturnsFalse() {
            assertThat(AgentUtils.isValidJson("not json at all")).isFalse();
        }
    ...
    class CleanResponse {
        ...
        void removesExcessiveWhitespace() {
            assertThat(AgentUtils.cleanResponse("hello   world\n\tnewline"))
                .isEqualTo("hello world newline");
        }

        @Test
        void removesBoldMarkdown() {
            assertThat(AgentUtils.cleanResponse("This is **bold** text"))
                .isEqualTo("This is bold text");
        }

        @Test
        void removesItalicMarkdown() {
            assertThat(AgentUtils.cleanResponse("This is *italic* text"))
                .isEqualTo("This is italic text");
        }

        @Test
        void trimsWhitespace() {
            assertThat(AgentUtils.cleanResponse("  hello  "))
                .isEqualTo("hello");
        }

        @Test
        void returnsEmptyForNull() {
            assertThat(AgentUtils.cleanResponse(null)).isEmpty();
        }
    }
}
